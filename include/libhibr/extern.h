...
#if !defined( _LIBHIBR_EXTERN_H )
#define _LIBHIBR_EXTERN_H

/* To export functions from the libhibr DLL define LIBHIBR_DLL_EXPORT
 * To import functions from the libhibr DLL define LIBHIBR_DLL_IMPORT
