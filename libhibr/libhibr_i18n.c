...
static int libhibr_i18n_initialized = 0;

/* Initializes library internationalization functions
 */
int libhibr_i18n_initialize(
     libcerror_error_t **error )
{
	static char *function = "libhibr_i18n_initialize";

	if( libhibr_i18n_initialized == 0 )
	{
