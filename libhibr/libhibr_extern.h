...
#if !defined( _LIBHIBR_INTERNAL_EXTERN_H )
#define _LIBHIBR_INTERNAL_EXTERN_H

#include <common.h>

#if !defined( __CYGWIN__ ) && !defined( _WIN32 ) && defined( __has_attribute )
#if __has_attribute( visibility )
#define LIBHIBR_INTERNAL	__attribute__((visibility("hidden"))) extern

#else
#define LIBHIBR_INTERNAL	extern
...
#define LIBHIBR_EXTERN_VARIABLE	LIBHIBR_INTERNAL
