...
{
	static char *function = "libhibr_notify_set_stream";
...
int libhibr_notify_stream_open(
     ...
     libcerror_error_t **error )
{
	static char *function = "libhibr_notify_stream_open";
...
int libhibr_notify_stream_close(
     libcerror_error_t **error )
{
	static char *function = "libhibr_notify_stream_close";
