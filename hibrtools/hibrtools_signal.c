...
void (*hibrtools_signal_signal_handler)( hibrtools_signal_t ) = NULL;
             ...
             hibrtools_signal_t signal )
{
	...
	switch( signal )
	{
		...
		case CTRL_C_EVENT:
			if( hibrtools_signal_signal_handler != NULL )
			{
				hibrtools_signal_signal_handler(
				 signal );
			}
			return( TRUE );
 ...
 */
void hibrtools_signal_initialize_memory_debug(
      void )
{
	int flag = 0;
 ...
 */
int hibrtools_signal_attach(
     void (*signal_handler)( hibrtools_signal_t ),
     libcerror_error_t **error )
{
	static char *function = "hibrtools_signal_attach";
...
#if defined( _MSC_VER )
	hibrtools_signal_initialize_memory_debug();
#endif
     ...
     libcerror_error_t **error )
{
	...
	hibrtools_signal_signal_handler = NULL;
