...
#if !defined( _HIBRTOOLS_GETOPT_H )
#define _HIBRTOOLS_GETOPT_H
...
typedef struct hibrtools_option hibrtools_option_t;

struct hibrtools_option
{
...
#define hibrtools_getopt( argument_count, argument_values, options_string ) \
...
system_integer_t hibrtools_getopt(
                  int argument_count,
...
void hibrtools_getopt_wrapped_fprint(
      FILE *stream,
...
void hibrtools_getopt_usage_fprint(
      FILE *stream,
      const char *program,
      const char *description,
      const hibrtools_option_t *options,
      int number_of_options );

int hibrtools_getopt_get_options_string(
     const hibrtools_option_t *options,
     int number_of_options,
...
#endif /* !defined( _HIBRTOOLS_GETOPT_H ) */
