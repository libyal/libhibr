...
extern mount_handle_t *hibrmount_mount_handle;
...
int __stdcall mount_dokan_CreateFile(
               ...
               DWORD share_mode HIBRTOOLS_ATTRIBUTE_UNUSED,
               DWORD creation_disposition,
               DWORD attribute_flags HIBRTOOLS_ATTRIBUTE_UNUSED,
               DOKAN_FILE_INFO *file_info )
{
	...
	HIBRTOOLS_UNREFERENCED_PARAMETER( share_mode )
	HIBRTOOLS_UNREFERENCED_PARAMETER( attribute_flags )
...
NTSTATUS __stdcall mount_dokan_ZwCreateFile(
                    const wchar_t *path,
                    DOKAN_IO_SECURITY_CONTEXT *security_context HIBRTOOLS_ATTRIBUTE_UNUSED,
                    ACCESS_MASK desired_access,
                    ULONG file_attributes HIBRTOOLS_ATTRIBUTE_UNUSED,
                    ULONG share_access HIBRTOOLS_ATTRIBUTE_UNUSED,
                    ULONG creation_disposition,
                    ULONG creation_options HIBRTOOLS_ATTRIBUTE_UNUSED,
                    DOKAN_FILE_INFO *file_info )
{
	libcerror_error_t *error = NULL;
	...
	HIBRTOOLS_UNREFERENCED_PARAMETER( security_context )
	HIBRTOOLS_UNREFERENCED_PARAMETER( file_attributes )
	HIBRTOOLS_UNREFERENCED_PARAMETER( share_access )
	HIBRTOOLS_UNREFERENCED_PARAMETER( creation_options )
...
int __stdcall mount_dokan_GetFileInformation(
               const wchar_t *path,
               BY_HANDLE_FILE_INFORMATION *file_information,
               DOKAN_FILE_INFO *file_info HIBRTOOLS_ATTRIBUTE_UNUSED )
#else
