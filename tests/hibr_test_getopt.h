...
#if !defined( _HIBR_TEST_GETOPT_H )
#define _HIBR_TEST_GETOPT_H
...
#define hibr_test_getopt( argument_count, argument_values, options_string ) \
...
system_integer_t hibr_test_getopt(
                  int argument_count,
...
#endif /* !defined( _HIBR_TEST_GETOPT_H ) */
